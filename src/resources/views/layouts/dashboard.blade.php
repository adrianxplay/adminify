...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="{{asset('vendor/adrianxplay/bootstrap/dist/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Menu CSS -->
...
<body class="fix-header">
    ...
    <script src="{{asset('vendor/asset/bootstrap/dist/js/bootstrap.min.js')}}"></script>
